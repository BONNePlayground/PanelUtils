...
/**
 * An enum of mob heads that are used to get proper head for entity.
 */
public enum MobHeadContainer
{
// ---------------------------------------------------------------------
...
// ---------------------------------------------------------------------
	 ...
	 */
	private final static Map<String, MobHeadContainer> BY_NAME = new HashMap<>();
...
// ---------------------------------------------------------------------
	 ...
	 */
	MobHeadContainer(String uuid, String textureValue)
	{
		this.uuid = uuid;
...
// ---------------------------------------------------------------------
	 ...
	 */
	public static MobHeadContainer getHead(String name)
	{
	...
	static
	{
		for (MobHeadContainer head : values())
		{
